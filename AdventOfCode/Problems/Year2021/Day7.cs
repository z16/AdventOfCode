...
internal static class Day7 {
	...
	private static Int32 Check(String line, Func<Int32, Int32, Int32> distance) =>
		Check(line.Split(',').Select(Int32.Parse).ToArray(), distance);

	private static Int32 Check(Int32[] array, Func<Int32, Int32, Int32> distance) =>
		Check(array, array.Min(), array.Max(), distance);
